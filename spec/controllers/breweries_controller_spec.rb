...
RSpec.describe BreweriesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new brewery" do

        post :create, params: {brewery: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(brewery_url(Brewery.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new brewery" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the brewery" do
        brewery = Brewery.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the brewery" do
        brewery = Brewery.create! valid_attributes
